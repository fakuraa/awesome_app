...
class AppTheme {
  static ThemeData buildThemeData(bool darkMode) {
    return ThemeData(
        ...
        cardTheme: cardThemeMode(darkMode),
        popupMenuTheme: popupMenuThemeData());
  }

  static cardThemeMode(bool darkMode) {
    return CardTheme(
  ...
  static popupMenuThemeData() {
    return PopupMenuThemeData(
        color: Colors.deepOrange.shade50, iconColor: Colors.deepOrange);
  }
}
